...
export const metadata: Metadata = {
  title: "Watercolor Paintings Gallery",
  description:
    "Browse watercolor paintings — from classic masterworks to contemporary watercolor art. Explore mediums, techniques, and artist collections.",
  alternates: {
    canonical: `${baseUrl}/paintings`,
  },
  openGraph: {
    title: "Watercolor Paintings Gallery",
    description: "Browse watercolor paintings — from classic masterworks to contemporary watercolor art.",
